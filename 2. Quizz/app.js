...
function addColors(results) {
  // Pour chaque résultat, on color le cadre de la réponse suivant l'index
...
// A chaque fois que l'on change de réponse, on reset la couleur de fond du bloc
radioInputs.forEach(radioInput => radioInput.addEventListener('input', resetColor))

function resetColor(e) {

  // On récupère le name de la question et on retire la 1ère lettre q1 -> 1 et on fait -1 pour récupérer l'index
